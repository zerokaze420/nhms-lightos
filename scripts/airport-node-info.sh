...
SUBSCRIPTION_RAW_PATH="${SUBSCRIPTION_RAW_PATH:-${SUBSCRIPTION_PATH}.raw}"
SUBSCRIPTION_RAW_QR_PATH="${SUBSCRIPTION_RAW_QR_PATH:-${SUBSCRIPTION_RAW_PATH}.png}"
SUBSCRIPTION_BASE64_PATH="${SUBSCRIPTION_BASE64_PATH:-${SUBSCRIPTION_PATH}}"
if [ "${SUBSCRIPTION_BASE64_PATH}" = "${SUBSCRIPTION_PATH}.b64" ]; then
...
if [ "${SUBSCRIPTION_BASE64_QR_PATH}" = "${SUBSCRIPTION_PATH}.b64.png" ]; then
  SUBSCRIPTION_BASE64_QR_PATH="${SUBSCRIPTION_QR_PATH}"
fi
